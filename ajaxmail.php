...
$wsub=$_POST['subject'];
$meesg=$_POST['mesg'];
if(trim($un)!="Your Name" && trim($em)!="Your Email" && trim($wsub)!="Your subject" && trim($meesg)!="Your message" && trim($un)!="" && trim($em)!="" && trim($wsub)!="" && trim($meesg)!="")
{
	if(filter_var($em, FILTER_VALIDATE_EMAIL))
	{
		...
		$headers .= 'From: <teqbees@gmail.com>' . "\r\n";

		if(mail('teqbees@gmail.com','Query for Dj Night',$message,$headers ))
		{
		mail($em,'Reply from Dj Night Template Team',$message_user,$headers );
